...
class _CreatePostScreenState extends State<CreatePostScreen> {
  ...
  Future<void> _createPost() async {
    ...
    final success = await PostService.createPost(_titleController.text, _contentController.text, _status, _imageBytes, _imageName);
    setState(() => _isLoading = true);
        ...
        child: Form(
          ...
          child: ListView(
            children: [
              ...
              SizedBox(
                height: 48,
                child: ElevatedButton(onPressed: _isLoading ? null : _createPost, 
                  child: _isLoading ? const CircularProgressIndicator(color: Colors.white) : Text(_status == 1 ? 'Publish' : 'Simpan Draft'),),
              )
            ],
          ),
        ),
