...
class ProductService {
  ...
  // Get all posts
  static Future<ProductModel> listProducts() async {
  ...
  static Future<ProductModel> listProductsByCategory(int idCategory) async {
    final token = await getToken();
    final response = await http.get(
      Uri.parse('$baseUrl?id_category=$idCategory'),
      headers: {HttpHeaders.authorizationHeader: 'Bearer $token'},
    );
